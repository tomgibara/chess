...
public class BoardTest extends TestCase {
	...
	public void testMoves() {
		...
		List<Move> moves = board.computeMoves(MoveConstraint.defaultWhite);
	...
	public void testPins() {
		...
		assertMovesAre("b5-b6,b5-b4,b5-b3,b5-b2,b5-b1", board.computeMoves(at("b5").asArea(), MoveConstraint.defaultBlack));
		assertMovesAre("", board.computeMoves(at("f3").asArea(), MoveConstraint.defaultWhite));
		assertMovesAre("h3-g3,h3-f3,h3-h2,h3-h1,h3-g2,h3-f1,h3-g4,h3-f5,h3-e6,h3-d7,h3-c8,h3-h4,h3-h5,h3-h6,h3-h7", board.computeMoves(at("h3").asArea(), MoveConstraint.defaultBlack));
	}
	...
	public void testKingMoves() {
		...
		List<Move> kingMoves = board.computeMoves(kingsArea, MoveConstraint.defaultBlack);
		assertMovesAre("e6-e7", kingMoves);
	}
	
	public void testStopCheck() {
		Board board = Notation.parseFENBoard("8/3k2Q1/8/4qn2/8/3K4/8/8");
		List<Move> moves = board.computeMoves(board.pieces.keySet().asArea(), MoveConstraint.defaultBlack);
	...
	public void testEnPassant() {
		...
		List<Move> moves1 = board.computeMoves(area, new MoveConstraint(Colour.BLACK, false, false, File.FL_B));
		assertTrue(moves1.contains(move("a4-b3")));
		List<Move> moves2 = board.computeMoves(area, new MoveConstraint(Colour.BLACK, false, false, null));
	...
	public void testCastling() {
		...
		List<Move> moves1 = board.computeMoves(area, new MoveConstraint(Colour.WHITE, true, false, null));
		assertTrue(moves1.contains(move("e1-c1")));
		List<Move> moves2 = board.computeMoves(area, new MoveConstraint(Colour.WHITE, false, false, null));
		...
		List<Move> moves = board.computeMoves(area, new MoveConstraint(Colour.WHITE, true, true, null));
